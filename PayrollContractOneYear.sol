...
contract PayrollContractOneYear is KeeperCompatibleInterface {
    ...
    function OwnerAddFundsEveryYear() public payable ContractOwnerCheck {
        require(msg.value == 2, "You need to have msg.value as 2 to payout worker biweekly!"); //26 = (56 weeks * (1/2) biweekly/weeks * 1 WEI/biweekly)
    }

    function checkUpkeep(bytes calldata) external override returns (bool upkeepNeeded, bytes memory) {
        require(address(this).balance > 0,"No funds in contract yet from Owner.");
        upkeepNeeded = (block.timestamp - lastTimeStamp) > 30; //Block every 30 seconds minimum. Biweekly: 1209600 seconds = (14 days*86400 seconds/day)
    }
